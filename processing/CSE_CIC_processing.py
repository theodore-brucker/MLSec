...
data_dir = 'C:/Users/theob/Code/COS-475-Project/Dataset/CSE-CIC-IDS2018/'

# Define the paths to the datasets
benign_path = os.path.join(data_dir, 'Wednesday-14-02-2018_TrafficForML_CICFlowMeter.csv')
mixed_path = os.path.join(data_dir, 'Friday-16-02-2018_TrafficForML_CICFlowMeter.csv')
...
def process_CIC_CAE():
    ...
    print(f'Saved dataloaders to {data_dir}')
